...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "holmesaggregator@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "holmesaggregator API";

        private String description = "holmesaggregator API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "holmesaggregator";
